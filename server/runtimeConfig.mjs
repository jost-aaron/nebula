...
export const readRuntimeConfig = (env = process.env) => ({
  ...
  backupRetentionMax: integer(env, "NEBULA_BACKUP_RETENTION_MAX", 0, { min: 0, max: 10_000 }),
  ...
  partyMaintenanceBatchSize: integer(env, "NEBULA_PARTY_MAINTENANCE_BATCH_SIZE", 250, { min: 1, max: 1_000 }),
  partyMaintenanceIntervalMinutes: integer(env, "NEBULA_PARTY_MAINTENANCE_INTERVAL_MINUTES", 60, { min: 5, max: 1_440 }),
  partyRetentionDays: integer(env, "NEBULA_PARTY_RETENTION_DAYS", 0, { min: 0, max: 3_650 }),
